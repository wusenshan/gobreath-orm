...
func main() {
	var (
		...
		jsonFile   = flag.String("json", "", "JSON 文档样例文件路径；指定后从样例推断 model+列闭包")
	...
	if *types == "" {
		...
		fmt.Fprintln(os.Stderr, "     ormgen -json sample.json [-pkg model] [-mode perType|twoFiles|singleFile] [-dir .]")
		os.Exit(1)
	}
